...
##################################################################################
# Goals: 
# Append latest news to the database
# Procedure:
# 1. load data from database
# 2. keep get latest news; if the news is in database, break
# 3. add the latest news not in database to database: Use if_exist = "apppend"
##################################################################################
...
if __name__ == "__main__": 
    ...
    # py -3.10 anue.py 3 友達 2023121610_anue_友達.json  
    ##################################################
